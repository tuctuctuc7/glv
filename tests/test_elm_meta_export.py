...
class ElmMetaExportTest(unittest.TestCase):
    ...
    def test_dashboard_exposes_privacy_safe_campaign_longevity_evidence(self):
        ...
        self.assertIn('id="campaignSpendBandTable"', html)
        self.assertIn("04C / Campaign longevity", html)
        self.assertIn("Many campaign objects are short; material campaigns run longer", html)
        self.assertNotIn("Campaigns run in short flights", html)
        self.assertIn("const CAMPAIGN_LONGEVITY =", app)
        self.assertIn("const CAMPAIGN_SPEND_BANDS =", app)
        ...
        self.assertIn("statusFilter: null", app)
        self.assertIn("campaigns: 1928, spend: 14606170826, share: 0.4750950445055156", app)
        self.assertIn("campaigns: 139, spend: 16137510875, share: 0.5249049554944845", app)
        self.assertIn("campaigns: 2067, spend: 30743681701, share: 1", app)
        self.assertIn("averageActiveDays: 108.61151079136691", app)
        self.assertIn("medianActiveDays: 94", app)
        ...
        self.assertIn("function renderCampaignSpendBands", app)
        self.assertIn("At or below 50M VND", app)
        self.assertIn("Over 50M VND", app)
        self.assertIn("Share of grand total", html)
        self.assertIn("No campaign-status filter", html)
        ...
        self.assertIn("of all observed campaign spend", app)
        self.assertIn("averageActiveDays", app)
